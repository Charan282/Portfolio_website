      ...
      <header id="home" className="relative h-[1100px] flex items-center justify-center bg-gradient-to-r from-gray-800 to-black">
        ...
        <div className="relative text-center text-white z-10 px-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center mb-10">
            ...
            <a href="https://drive.google.com/file/d/147lK3c7Mm4t9vcysnEqbcVO2r1_uqfRO/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white hover:bg-white hover:text-black px-8 py-3 rounded-full font-semibold text-xl transition flex items-center gap-2">
